...
public class Positions {
    ...
    static final double SPEED_MODIFIER = 0.6;

    static final boolean INTAKE_UP = true;
    static final double INTAKE_POWER = 0.5;
    static final long INTAKE_DURATION = 250;
    static final double RELEASE_POWER = 0.8;
    static final long RELEASE_DURATION = 250;

    static final double VSLIDE_POWER = 1;
    static final long VSLIDE_DURATION = 100;

    static final double INTAKE_LIFT1_UP = 0;
    static final double INTAKE_LIFT2_UP = 1;
    static final double INTAKE_LIFT1_DOWN = 0.6;
